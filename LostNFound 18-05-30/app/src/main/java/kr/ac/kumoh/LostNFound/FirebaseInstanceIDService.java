...
public class FirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    public void sendRegistrationToServer(String androidId, String token) {  //DB에 안드로이드 고유 ID값과 토큰 값 쌍 저장
        ...
        Request request = new Request.Builder().url("http://192.168.123.122/registtoken.php").post(body).build();
        //Request request = new Request.Builder().url("http://192.168.0.5/registtoken.php").post(body).build();
        try {
