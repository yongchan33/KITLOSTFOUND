                    ...
                    /*new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                //토큰값 넣음
                                root.put("to", "dl28VvKPMx4:APA91bFo806fR8dQ3GZ7S0z8MrU8Wi0tX2GALYVQypQ5eEIZBD2kqu0hUgFeNoiBVi019il-y2geZLZy5xaZAD_Ai_Kup4ZOnT4WafbncPhG7uY6KhTRm0Q55IWzUZNZ20MEhda0GVWW");                      //토큰값넣음
                                // FMC 메시지 생성 end
                                ...
                                os.writenotice(root.toString().getBytes("utf-8"));     //request body에 data 셋팅
