...
public class LeaveActivity extends AppCompatActivity {
    ...
    private String soriginpassword;
    ...
    public class leaveDB extends AsyncTask<Void, Integer, Void> {  // DB에서 회원 탈퇴
        ...
        protected Void doInBackground(Void... unused) {
            ...
            try {
                /* 서버연결 */
                //URL url = new URL("http://10.0.2.2/leave.php");
                //URL url = new URL("http://192.168.0.5/leave.php");
                URL url = new URL("http://192.168.123.122/leave.php");
